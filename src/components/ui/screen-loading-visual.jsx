...
import StartupVisual from '@/components/startup/StartupVisual';
import ErrorState from './error-state';
import LoadingSpinner from './loading-spinner';

export default function ScreenLoadingVisual({ branded }) {
  ...
  return branded ? <StartupVisual /> : <LoadingSpinner size="lg" />;
}
