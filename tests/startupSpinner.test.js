...
test('boot uses the branded hexagon while subsequent loading retains the shared spinner', async () => {
  ...
  assert.match(html, /class="startup-hexagon"/);
  assert.match(html, /class="startup-lines"/);
