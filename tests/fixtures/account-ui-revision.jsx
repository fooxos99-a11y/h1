...
function Fixture() {
  ...
  return <main className="student-home" dir="rtl">
    <StudentHomeHeader showLevel={getSiteConfig(new URLSearchParams(location.search).get('site') || 'madarij').features.studentLevel !== false} points={8000} progress={30} level={30} onOpen={() => {}} onLogout={() => {}} />
